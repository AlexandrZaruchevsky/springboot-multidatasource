...
@EnableJpaRepositories(
        ...
        basePackages = {"ru.zaa.springboot.multidatasource.repository.firebird"},
...
public class FireBirdDBConfig {
    ...
    @ConfigurationProperties(prefix = "spring.firebird.datasource")
    public DataSource dataSource() {
        return DataSourceBuilder.create().build();
    }

    @Primary
    @Bean("fbEntityManagerFactory")
    ...
    public PlatformTransactionManager transactionManager(
            @Qualifier("fbEntityManagerFactory") EntityManagerFactory entityManagerFactory
    ){
